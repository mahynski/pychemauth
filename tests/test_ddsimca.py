...
class BenchmarkMdatools_UnscaledRobust(unittest.TestCase):
    ...
    def test_limits(self):
        ...
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__h0_, 3.2926643176398445, decimal=6
        )
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__q0_, 0.005740692404315845, decimal=6
        )
    ...
    def test_transform(self):
        ...
        t_ref = np.array(
            [
                [-1.08962048, -0.19293659, -0.35231781],
        ...
        np.testing.assert_almost_equal(
            self.model.transform(self.X_ver), t_ref, decimal=6
        )

        t_ref = np.array(
            [
                [2.70457524e00, -3.69909699e-01, -1.86575094e00],
                [2.82837658e00, -9.58383156e-02, -1.75778096e00],
                [1.86563927e00, 8.85379047e-02, -2.38850227e00],
                [2.45608738e00, -1.31840573e-01, -2.08903467e00],
                [2.63365881e00, -3.08465296e-01, -1.87479166e00],
                [2.53769679e00, 1.48117865e-02, -1.95195864e00],
                [3.33402564e00, -1.26223770e-01, -1.87127066e00],
                [1.62831438e00, 1.93322972e-01, -2.94757633e00],
                [2.39758838e00, -1.17700928e-01, -2.24274986e00],
                [2.24944145e00, 1.12451840e-01, -2.36723167e00],
                [2.25943443e00, 7.81571312e-02, -2.29081079e00],
                [2.23480402e00, -1.04841261e-01, -1.88776764e00],
                [2.51146193e00, -3.75361642e-01, -1.76583856e00],
                [2.28448003e00, -1.83675548e-01, -2.22268453e00],
                [2.66711221e00, -6.07722626e-02, -1.78920273e00],
                [2.13285864e00, -3.04099939e-01, -2.20349264e00],
                [1.92808270e00, 8.35945960e-02, -2.84228642e00],
                [2.69700670e00, -3.48625039e-01, -2.16326716e00],
                [2.54920976e00, 2.72346400e-03, -2.26194175e00],
                [2.38482095e00, -1.91591906e-01, -2.12388261e00],
                [3.23500436e00, -5.98354917e-01, -1.33359454e00],
                [2.28976338e00, 9.64687412e-02, -2.03574094e00],
                [2.75676015e00, -2.76785384e-01, -1.81843611e00],
                [2.86022552e00, -5.53203195e-02, -1.88911510e00],
                [2.54608532e00, -2.26657959e-01, -2.09246084e00],
                ...
                [1.56882472e00, 6.91221367e-03, -1.02068941e-01],
                ...
                [-1.05768706e00, 3.25500587e-02, 1.19675118e-01],
                ...
                [1.52663279e00, -1.20506810e-01, -7.29628915e-02],
                ...
                [-1.12816902e00, 4.00158849e-01, 7.39768679e-01],
                [-2.75018603e00, 6.26751102e-02, 9.33993721e-01],
                [-2.26729739e00, -7.30661391e-03, 8.62950387e-01],
                [-2.41127616e00, 7.05430041e-01, 4.02628329e-01],
                [-9.77597643e-01, 1.56996032e-01, 6.43155141e-01],
                [-2.56894845e-01, 3.91843877e-01, 8.25325106e-01],
                [-1.19929619e00, 6.28826416e-01, 3.73252761e-01],
                [-3.13405340e00, 6.04787982e-01, 4.67360926e-01],
                ...
                [-2.10048413e00, 1.73998707e-01, 5.03795896e-01],
                [-5.88246573e-01, 3.97281342e-01, 2.73849480e-01],
                [-1.88232522e00, -8.23820286e-02, 4.72009781e-01],
                [-3.05565290e00, 3.37090268e-01, 1.70590804e-01],
                [-7.37232775e-01, 9.66237375e-02, 4.29421221e-01],
                [-2.55499828e00, -6.60787316e-02, 5.87178785e-01],
                [-1.19666100e00, 4.48593203e-01, 5.09632611e-01],
                [-1.54931424e00, 2.22805792e-01, 3.05413435e-01],
                [-1.40470694e00, 2.08102673e-01, 1.28206748e-01],
                [-1.84990255e00, 5.52719254e-01, 6.38141941e-01],
                [-1.29402303e00, 2.87087342e-01, 3.29236767e-01],
                [-1.09424564e00, 3.06471060e-01, 3.61531974e-01],
                [-5.67560603e-01, 5.71083396e-01, 4.78305667e-01],
            ]
        )
        np.testing.assert_almost_equal(
            self.model.transform(self.Xt), t_ref, decimal=6
        )
...
class BenchmarkMdatools_ScaledRobust(unittest.TestCase):
    ...
    def test_limits(self):
        """Test the limits."""
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__h0_, 3.432719122682241, decimal=6
        )
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__q0_, 0.06563691425828075, decimal=6
        )
    ...
    def test_transform(self):
        ...
        t_ref = np.array(
            [
                [-2.00422627, 0.6003292, -1.11084334],
        ...
        t_ref = np.array(
            [
                [7.00041967, -1.25974945, -5.07751791],
...
class BenchmarkMdatools_Unscaled(unittest.TestCase):
    ...
    def test_limits(self):
        """Test the limits."""
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__h0_, 2.8799999999999977, decimal=6
        )
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__q0_, 0.007817834405397996, decimal=6
        )
...
class BenchmarkMdatools_Scaled(unittest.TestCase):
    ...
    def test_limits(self):
        ...
        np.testing.assert_almost_equal(
            self.model._DDSIMCA_Model__q0_, 0.10584179785146551, decimal=6
        )
        np.testing.assert_equal(self.model._DDSIMCA_Model__Nh_, 4)
        np.testing.assert_equal(self.model._DDSIMCA_Model__Nq_, 1)
