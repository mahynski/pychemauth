...
class BenchmarkMdatools_ScaledRobust(unittest.TestCase):
    ...
    def test_limits(self):
        ...
        np.testing.assert_almost_equal(
            self.model._PCA__h0_, 4.517604926884162, decimal=6
        )
        np.testing.assert_almost_equal(
            self.model._PCA__q0_, 0.3347298612776225, decimal=6
        )
    ...
    def test_loadings(self):
        ...
        loadings = np.array(
            [
                [0.37528576, 0.13545854, -0.07237117, -0.07431853, -0.18590711],
        ...
        np.testing.assert_almost_equal(
            self.model._PCA__pca_.components_.T, loadings, decimal=6
        )
    ...
    def test_scores(self):
        ...
        scores = np.array(
            [
                [5.33252845, -0.67656982, 1.0673076, -1.10080565, -1.05952338],
        ...
        np.testing.assert_almost_equal(
            self.model.transform(self.X), scores, decimal=6
        )
    ...
    def test_transform(self):
        ...
        result = np.array(
            [
                [2.69489784, -0.1562752, 0.01471942, -0.73489755, 0.24459898],
        ...
        np.testing.assert_almost_equal(
            self.model.transform(x_test), result, decimal=6
        )
...
class BenchmarkMdatools_UnscaledRobust(unittest.TestCase):
    ...
    def test_limits(self):
        """Test h and q limits."""
        np.testing.assert_almost_equal(
            self.model._PCA__h0_, 5.12575970787771, decimal=6
        )
        np.testing.assert_almost_equal(
            self.model._PCA__q0_, 17.26054862016219, decimal=6
        )
    ...
    def test_scores(self):
        ...
        np.testing.assert_almost_equal(
            self.model.transform(self.X), scores, decimal=4
        )
    ...
    def test_transform(self):
        ...
        np.testing.assert_almost_equal(
            self.model.transform(x_test), result, decimal=5
        )
...
class BenchmarkMdatools_Scaled(unittest.TestCase):
    ...
    def test_limits(self):
        ...
        np.testing.assert_almost_equal(
            self.model._PCA__q0_, 0.3811163636820247, decimal=6
        )
...
class BenchmarkMdatools_Unscaled(unittest.TestCase):
    ...
    def test_limits(self):
        """Test h and q limits."""
        np.testing.assert_almost_equal(
            self.model._PCA__h0_, 4.8437500000001, decimal=6
        )
        np.testing.assert_almost_equal(
            self.model._PCA__q0_, 17.792849572635518, decimal=6
        )
